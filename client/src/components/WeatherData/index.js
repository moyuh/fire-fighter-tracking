  ...
  return (
    <>
      ...
      <ul className='forecast-list'>
        <li>
          Min Temp:{' '}
          {toFahrenheit(props.searchedWeather.minTemp.value.toFixed(0))}° F
        </li>
        <li>
          Max Temp:{' '}
          {toFahrenheit(props.searchedWeather.maxTemp.value.toFixed(0))}° F
        </li>
        <li>Current Temp: {props.searchedWeather.temp}° F</li>
        <li>
          Current Relative Humidity:{' '}
          {props.searchedWeather.relativeHumidity.value}%
        </li>
        <li>
          20ft Winds:{' '}
